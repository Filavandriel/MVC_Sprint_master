        ...
        <div class="container fadeIn">
             ...
             <div class="row justify-iitems-center" style="margin-top:6%;">
                ...
                <div class="col-12">
                      ...
                      <h1 class="text-right">Okna aluminiowe</h1>
                </div>
           </div>
            
             <div class="row">
            <div class="col-9 offset-1">
                <a href="http://kmt.com.pl/pl/">   <img class="b1" src="<?php echo IMG_PATH; ?>companies/ALUDOOR.PNG" alt="KMT" height="75px"> </a>
          ...
          <h2>AluDoor</h2>
                ...
                <div id="collapseone" class="collapse" role="tabpanel" aria-labelledby="headingone">
                    <div class="card-block">
                      <p class="p1"> Firma Aludoor została założona w 2009 roku i od początku ich celem było tworzenie estetycznej stolarki najlepszej jakości. Produkty tworzone przez firmę są w pełni dopasowane do aktualnych trendów architektonicznych i potrzeb klientów.</p>
                       <hr>
                     <p class="p1">W swojej działalności stosują sprawdzone od wielu lat systemy profili firmy PONZIO, które pozwalają w sposób profesjonalny zrealizować nawet najtrudniejsze zadania techniczne. Flagowe produkty w postaci aluminiowych okien, drzwi, fasad i ogrodów zimowych od lat cieszą się niesłabnącym zainteresowaniem na rynku polskim jak i zagranicznym. Innowacyjne rozwiązania systemowe zastosowane w ich wyrobach spełniają rygorystyczne wymogi energooszczędności, komfortu oraz bezpieczeństwa.</p>
                     <hr>

                     <p class="p1">Dewizą firmy jest solidność , terminowość i profesjonalizm . Zadowolenie Klienta jest dla nich najważniejszą motywacją do dalszej pracy. Zapraszamy do skorzystania z ichj wiedzy i doświadczenia.</p>
