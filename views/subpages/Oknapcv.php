        ...
        <div class="container fadeIn">
             ...
             <div class="row justify-iitems-center" style="margin-top:6%;">
                ...
                <div class="col-12">
                      ...
                      <h1 class="text-right">Okna PCV</h1>
        </div>
          </div>
                          <div class="row">
            <div class="col-9 offset-1">
                <a href="http://kmt.com.pl/pl/">   <img class="b1" src="<?php echo IMG_PATH; ?>companies/Grobud.png" alt="KMT" height="50px"> </a>
                <a href="http://wiked.pl/drzwi.php">   <img class="b1" src="<?php echo IMG_PATH; ?>companies/Redan.png" alt="Wikęd" height="50px"> </a>
                <a href="http://www.delta.net.pl/">   <img class="b1" src="<?php echo IMG_PATH; ?>companies/aluplast.png" alt="Delta" height="90px"> </a>
          ...
          <h2>Grobud</h2>
                ...
                <div id="collapsetwo" class="collapse" role="tabpanel" aria-labelledby="headingtwo">
                    <div class="card-block">
                        <p class="p1"> Firma GROBUD z Grodziska Wielkopolskiego jest cenionym  producentem okien PCV oraz drzwi wejściowych, rolet zewnętrznych i stolarki aluminiowej. Historia firmy sięga lat 70. XX wieku. GROBUD to firma z tradycją, ale też śmiało spoglądająca w przyszłość. Wychodzą naprzeciw potrzebom Klientów oczekujących rozwiązań śmiałych, innowacyjnych i skutecznych.</p>
                        <hr>
                        <p class="p1"> Okna plastikowe oraz zróżnicowane wyroby z zakresu stolarki aluminiowej cieszą się dziś coraz większym zainteresowaniem wśród osób, dla których najwyższa jakość produktu jest równie istotna jak jego elegancki, oryginalny wygląd oraz wygoda użytkowania.</p>
                        <hr>

                        <p class="p1">Za wyborem stolarki aluminiowej przemawia jej wytrzymałość i odporność na zmieniające się warunki atmosferyczne. Warta podkreślenia jest również jej wszechstronność – z profili aluminiowych można tworzyć drzwi, okna, fasady, ścianki działowe, witryny, zabudowy oraz wiele innych konstrukcji. Jedynym ograniczeniem są tu granice wyobraźni. Nic zatem dziwnego, że zabudowa z aluminium jest tak chętnie wybierana nie tylko przy urządzaniu domów czy mieszkań, ale też sklepów, galerii handlowych oraz obiektów użyteczności publicznej.  </p>
          ...
          <h2>Redan</h2>
                ...
                <div id="collapsesix" class="collapse" role="tabpanel" aria-labelledby="headingsix">
                    <div class="card-block">
                        <p class="p1">Rozpoczynając produkcję okien w 2000 roku uznali, że sukces i satysfakcję osiągną tylko wtedy,
                        gdy uda się nam połączyć przystępną cenę, krótki czas realizacji z bezkompromisową jakością. Patrząc na dynamiczny rozwój przedsiębiorstwa jesteśmy przekonani, że się im to udało. </p>

                        <p class="p1">Dzisiaj dysponują najnowocześniejszym parkiem maszynowym w kraju, a dzięki częściowemu wykorzystaniu środków z funduszy unijnych produkcja odbywa się w nowo wybudowanym zakładzie.</p>
                        <hr>

                        <p class="p1">Ich możliwości produkcyjne to około 7 tysięcy okien i drzwi miesięcznie, które z powodzeniem znajdują nabywców w północno-zachodniej Polsce a także w: Niemczech, Szwecji, Norwegii, Danii, Belgii, Holandii ,Francji czy we Włoszech. Szczególnie dumni są również z faktu, że udało się im zbudować zespół zaangażowanych i podobnie myślących ludzi, dążących do osiągnięcia wyznaczonego celu. </p>
                            </div>
                        </div>
                      </div>
          ...
          <h2>Aluplast</h2>
                ...
                <div id="collapsefive" class="collapse" role="tabpanel" aria-labelledby="headingfive">
                    <div class="card-block">
                        <p class="p1"> Polska spółka utworzona w 1995 roku w Poznaniu zatrudniała na początku swojej działalności 8 osób i osiągnęła obrót na poziomie 4 mln PLN. Obecnie firma zatrudnia ok. 400 osób i realizuje obroty na poziomie ok. 400 mln PLN. Na powierzchni ponad 60 000 m2 powstał nowoczesny zakład produkcyjny, a ciągłe inwestycje w bazę technologiczną gwarantują najwyższy poziom techniczny oferowanych rozwiązań. Osiemnaście lat aktywności firmy aluplast w naszym kraju pokazuje, że konsekwentnie realizowana prorozwojowa polityka może gwarantować długookresowy sukces.</p>
                        <hr>
                        <p class="p1"> Jednym z fundamentów filozofii firmy jest innowacyjność, przejawiająca się w integrowaniu poszczególnych linii produktów w systemy i ich stałym rozwijaniu, co umożliwia ich ciągłą rozbudowę i pozwala posiadać w ofercie rozwiązania najlepiej dostosowane do potrzeb rynku. Tym samym rozwijając istniejące systemy aluplast przesuwa je w górę wyznaczając stale nowe standardy. Technologiczna przewaga stanowi podstawę strategii produktów aluplast. Przywództwo technologiczne jest przy tym ściśle związane z ciągłym koncentrowaniem się na kliencie i jego potrzebach, które są często bodźcem do ulepszania naszych produktów. </p>
                        <hr>

                        <p class="p1">To właśnie bogactwo oferty i jej innowacyjność są jedną z przyczyn osiągnięcia przez firmę aluplast pozycji lidera w Polsce. Praktycznie co roku wprowadzane są na rynek nowe rozwiązania, umożliwiające zwiększanie konkurencyjności współpracujących z nami producentów okien. Potwierdzeniem tego faktu są wyniki, realizowanych od kilku lat przez Centrum Analiz Branżowych, badań opinii producentów okien o dostawcach profili PVC. Firma aluplast jest w nich najwyżej oceniania w kategoriach: najszersza oferta, oferta o najlepszej relacji ceny do jakości oraz najbardziej innowacyjna firma. </p>
